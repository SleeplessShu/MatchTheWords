...
class SettingsFragment : Fragment(R.layout.settings_fragment) {
    ...
    private fun setupObservers() {
        ...
        vm.scriptToggle.observe(viewLifecycleOwner){ state ->
            binding.nativeOrLatinLanguageToggle.isVisible = state.isScriptVisible
            binding.btnLatin.isChecked = state.isScriptLatin
            binding.btnNative.isChecked = !state.isScriptLatin
            binding.btnNative.setText(state.nativeButtonText)
            binding.btnLatin.setText(state.latinButtonText)
        }
        binding.btnLatin.setOnClickListener { vm.latinScriptSelected() }
        binding.btnNative.setOnClickListener { vm.nativeScriptSelected() }
